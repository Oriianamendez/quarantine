...
function InformationRow({ information }) {
  ...
  return (
    <tr>
      ...
      <td className="description">{information.transactionType}</td>
      <td className="description">{information.transactionInstrument}</td>
      <td className="description">{information.retryCount}</td>
      <td className="description">{information.sequenceKey}</td>
      <td className="description">{information.updatedAt}</td>
    </tr>
  );
}
    ...
    <table className="head">
      <thead>
        <tr>
          ...
          <th className="heading">transactionType</th>
          <th className="heading">transactionInstrument</th>
          <th className="heading">retryCount</th>
          <th className="heading">sequenceKey</th>
          <th className="heading">updatedAt</th>
        </tr>
      </thead>
      <tbody>{rows}</tbody>
    </table>
